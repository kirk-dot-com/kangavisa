// GET /api/export/docx?subclass=500&caseDate=2026-03-01
// US-D1 — Server-side DOCX generation via docx library
...
export async function GET(req: NextRequest) {
    ...
    try {
        ...
        const filename = `kangavisa-pack-${subclass}-${caseDateStr}.docx`;
        ...
        return new Response("DOCX generation failed — check server logs.", { status: 500 });
    }
}
